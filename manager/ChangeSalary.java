...
public class ChangeSalary extends javax.swing.JFrame {

    /**
     * Creates new form ChangeSalary
     */
    public ChangeSalary() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Choose the position");

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));

        jLabel2.setText("Enter the new salary");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChangeSalary.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
